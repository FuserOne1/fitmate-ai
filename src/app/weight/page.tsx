      ...
      <main className="max-w-3xl mx-auto px-4 py-6">
        <div className="bg-[hsl(var(--card))] rounded-3xl p-8 shadow-lg border border-[hsl(var(--border))] text-center">
          <div className="w-20 h-20 bg-purple-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
            <Scale className={`w-10 h-10 ${themeConfig.colors.primaryText}`} />
          </div>
          <h2 className="text-2xl font-bold text-[hsl(var(--text-primary))] mb-2">Взвешивания</h2>
          <p className="text-[hsl(var(--text-secondary))] mb-6">Записывай вес, отслеживай прогресс и получай AI-анализ трендов</p>
