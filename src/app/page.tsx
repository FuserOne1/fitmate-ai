...
import { Utensils, Droplets, Scale, MessageCircle, Heart, Footprints, Dumbbell } from 'lucide-react'
    ...
    <div className={`min-h-screen ${themeConfig.colors.bg} transition-colors duration-300`}>
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <Link href="/workouts" className="bg-[hsl(var(--card))] rounded-2xl p-5 shadow-md hover:shadow-lg transition-all active:scale-95 border border-[hsl(var(--border))]">
            <div className="w-12 h-12 bg-orange-500/10 rounded-xl flex items-center justify-center mb-3">
              <Dumbbell className="w-6 h-6 text-orange-500" />
            </div>
            <h3 className="font-semibold text-[hsl(var(--text-primary))]">Тренировки</h3>
            <p className="text-sm text-[hsl(var(--text-secondary))]">Активность</p>
          </Link>

          <Link href="/settings" className="bg-[hsl(var(--card))] rounded-2xl p-5 shadow-md hover:shadow-lg transition-all active:scale-95 border border-[hsl(var(--border))]">
            <div className="w-12 h-12 bg-gray-500/10 rounded-xl flex items-center justify-center mb-3">
              <span className="text-2xl">⚙️</span>
            </div>
            <h3 className="font-semibold text-[hsl(var(--text-primary))]">Настройки</h3>
            <p className="text-sm text-[hsl(var(--text-secondary))]">Профиль</p>
          </Link>
        </div>
