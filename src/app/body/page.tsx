    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-100">
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-lg border-b border-rose-100">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-gray-800">Фото тела</h1>
        </div>
      </header>
      <main className="max-w-7xl mx-auto px-4 py-6">
        <div className="bg-white rounded-3xl p-8 shadow-lg shadow-rose-100 text-center">
          <div className="text-4xl mb-4">📸</div>
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Фото тела</h2>
          <p className="text-gray-600 mb-6">Загружай фото и отслеживай визуальный прогресс</p>
